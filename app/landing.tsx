  ...
  return <div className="landing-page">
    ...
    <main className="landing-main">
      <header className="landing-header">
        ...
        <div className="landing-header-right"><span className="landing-demo-pill">SIH26047 · CareSetu</span><button className="landing-header-register" onClick={onEmergency}>Emergency help <ArrowRight size={15}/></button></div>
      </header>
